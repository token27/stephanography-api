...
var digUpNextSection = function () {
    ...
    if (_password) {
        var decipher = crypto.createCipheriv('aes-256-ctr', _password);
...
var embedSection = function (buffer) {
    ...
    if (_password) {
        var cipher = crypto.createCipheriv('aes-256-ctr', _password);
...
module.exports = {
    ...
    embed: function (imageFile, fileToEmbed, outputFile, password) {
        ...
        var fileName = new Buffer.from(fileToEmbed.match(/([^\/]*)$/)[1]);
